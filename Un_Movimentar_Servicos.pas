...
queria poder fazer estas alterações,que te enviei também inserir valores
enfim ao invés de apenas visualizar poder inserir dados na os se tiver
como fazer isto sem te dar tanto trabalho, seria bom mas se for muito
trabalhoso, deixa para outra hora
...
e para que eu inserir os dados referente ao serviço executado e se precisar colocar
alguma coisa no campo OBSERVAÇÃO
}
